...
namespace Modules.EmbeddedAdventures
{
    /// <summary>
    ...
    /// </summary>
    public class LightningDetectorI2C
    {
        ...
        private byte TuneCapSetting = 3; //my test say 4 their bag said 3
        ...
        public LightningDetectorI2C(byte calNumber)
        {
        ...
        {
            input = new InterruptPort(GHI.Pins.FEZCerbuinoBee.Socket2.Pin3, true, Port.ResistorMode.Disabled, Port.InterruptMode.InterruptEdgeHigh);
        ...
        public bool Calibrate()
        {
            ...
            if (
                i2c.Execute(new I2CDevice.I2CTransaction[] { I2CDevice.CreateWriteTransaction(new byte[] { 0x3D, 0x96 }) },
                    1000) == 0)
            {
                Debug.Print(lightningDetectorFailedToPerformI2cTransaction);
            }
        ...
        private void input_OnInterrupt(uint data1, uint data2, DateTime time)
        {
            ...
            switch (source)
            {
                ...
                case 0x8: // Lightning
                    ...
                    break;
                default:
                    Debug.Print("Unknown interrupt source = " + source);
                    break;
            }
        }
        ...
        private void RegisterWrite(Register register, BitMask mask, byte data)
        {
            ...
            try
            {
                if (
                    i2c.Execute(
                        new I2CDevice.I2CTransaction[] { I2CDevice.CreateWriteTransaction(new[] { (byte)register, regval }) }, 1000) == 0)
                {
                    Debug.Print(lightningDetectorFailedToPerformI2cTransaction);
                }
            }
